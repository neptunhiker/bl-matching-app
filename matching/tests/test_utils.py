...
from matching.utils import get_deadline, get_standard_deadline, get_standard_extension_deadline
...
class TestGetStandardDeadline:
    
    def test_monday(self):
        start = datetime(2024, 6, 3, 9, 30)  # Monday 9:30
        deadline = get_standard_deadline(start)
...
class TestGetStandardExtensionDeadline:
    
    def test_Monday(self):
        start = datetime(2024, 6, 3, 18, 5)  # Monday 18:05
        deadline = get_standard_extension_deadline(start)
